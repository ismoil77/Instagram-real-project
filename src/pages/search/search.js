...
export const postUserHistory = createAsyncThunk("searchUsers/postUserHistory", async (id, {dispatch}) => {
    try {
...
export const delUserHistory = createAsyncThunk("searchUsers/delUserHistory", async (id, {dispatch}) => {
    try {
...
export const delUserHistorys = createAsyncThunk("searchUsers/delUserHistorys", async (_, { dispatch }) => {
    try {
